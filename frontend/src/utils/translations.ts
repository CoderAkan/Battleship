export const translations = {
    ...
    ru: {
        ...
        createRoom: "Создать битву",
        joinRoom: "Войти в битву",
        roomCode: "Код битвы",
